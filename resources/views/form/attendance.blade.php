                                ...
                                <tr>
                                    <td>
                                        <h2 class="table-avatar">
                                            ...
                                            <a href="profile.html">{{$attendance['employee']['name']}}</a>
                                        </h2>
                                    </td>
                                        @foreach($attendance['attendance_by_date'] as $innerkey=>$attendancebydate)
                                    
        
                                        
                                                <td>
                                                    @foreach($attendancebydate as $singleattendance)
                                                 @foreach($datesOnly as $date)
